...
<template>
      ...
      <v-card>
        <v-card-title class="headline">Short Haul Estimator</v-card-title>
...
export default {
  name: 'ShortHaulEstimator',
 components: {
    EmailEstimate
  },
  props:['minPoundage', //3000lb
  ...
  data () {
    return{ minWeightCost:0.0, fuelWorkCompCA:.227, rateQt1:28.67 , rateQt2:22, estimateWeight:5000, laborCost:0.0, email:'', 
