  ...
  <div id="app">
    ...
    <f7-views>
      <f7-view id="main-view" navbar-through :dynamic-navbar="true" main>
        ...
        -->
          <f7-nav-center sliding>Custom Order Processor Web & Mobile Demo</f7-nav-center>
          <f7-nav-right>
           <p id="update-date">12/10/2017</p>
          </f7-nav-right>
        </f7-navbar>
        <!-- Pages -->
        <f7-pages>
          <f7-page>
            ...
            <f7-navbar v-if="$theme.material">
              ...
              <f7-nav-center sliding>Quote Demo</f7-nav-center>
              <f7-nav-right>
                <f7-link icon="icon-bars" open-panel="right"></f7-link>
              </f7-nav-right>
            </f7-navbar>
            <!-- Page Content -->
            <f7-block-title>Welcome to the Custom Order Processor</f7-block-title>
            <f7-block inner>
              <p>Regions: CA, Vegas/Henderson, Seattle, Tucson/Phx, Baltimore</p>
              <p>Move Types: Local, Basic Short Haul, Basic IntraState</p>
            </f7-block>
            <f7-block-title>Navigation</f7-block-title>
            <f7-list>
              <f7-list-item link="/quoter/" title="Quoter"></f7-list-item>
              <f7-list-item link="/dispatch/" title="Dispatch"></f7-list-item>

              <f7-list-item link="/form/" title="Profile"></f7-list-item>
        ...
        -->
            ...
            <f7-block>
              <f7-grid>
                <f7-col width="50">
                   <f7-button><a href="http://j4uinc.com/ssquoter/demo/android-debug.apk" class="external">Download Android Link</a></f7-button>
                </f7-col>
                <f7-col width="50">
